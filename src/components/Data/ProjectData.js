...
const ProjectData = [
    {
        ...
        technologies: ['React', 'Next.js', 'TypeScript', 'Redux', 'Tailwind CSS', 'DaisyUI', 'Firebase', 'React-Hot-Toast', 'tailwindcss', 'daisyUI', 'React-icons'],
    ...
    },
    {
        ...
        client: 'https://github.com/shebamart/science_bee_web',
    ...
    },
    {
        ...
        technologies: ['React', 'TypeScript', 'Tailwind CSS', 'DaisyUI', 'Firebase', 'React-Hot-Toast', 'tailwindcss', 'daisyUI', 'React-icons'],
    ...
    },
    {
        ...
        technologies: ['React', 'Tailwind CSS', 'DaisyUI', 'Firebase', 'React-Hot-Toast', 'tailwindcss', 'daisyUI', 'React-icons'],
